...
export const pi: Messages = {
  ...
  pages: {
    ...
    about: {
      ...
      debugModeEnabledNoticeTitle: 'Bilge mode enabled',
      debugModeEnabledNotice: 'Bilge tools now be in the main menu.',
      debugModeAlreadyEnabledNoticeTitle: 'Already aboard',
    ...
    debug: {
      ...
      heartbeatQualityChecking: 'Checkin’',
      heartbeatQualityHealthy: 'Shipshape',
      heartbeatQualityGood: 'Good',
      heartbeatQualityOkay: 'Fair',
      ...
      eventsToastGroupSubtitle:
        'Preview the app-level popup variants without needin’ a real workflow failure.',
      ...
      eventToastSuccessHint: 'Shows the confirmation style used fer finished actions.',
      eventToastSuccessTitle: 'Stowed',
      eventToastSuccessMessage: 'The popup system be ready fer success messages.',
      eventToastInfoLabel: 'Info popup',
      eventToastInfoHint: 'Shows the neutral style used fer useful notices.',
      eventToastInfoTitle: 'Heads up',
      eventToastInfoMessage: 'This be the informational popup style.',
      eventToastWarningLabel: 'Warning popup',
      eventToastWarningHint: 'Shows the caution style when a thing needs attention.',
      eventToastWarningTitle: 'Check this',
      eventToastWarningMessage: 'This warning popup marks a fixable issue.',
      ...
      eventToastErrorMessage: 'This error popup be announced assertively.',
      eventToastPlainLabel: 'Plain popup',
      eventToastPlainHint: 'Shows a message-only popup without title or icon.',
