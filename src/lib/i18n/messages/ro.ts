...
export const ro: Messages = {
  ...
  pages: {
    ...
    debug: {
      ...
      heartbeatQualityChecking: 'Verificare',
      heartbeatQualityHealthy: 'Sănătos',
      heartbeatQualityGood: 'Bun',
      heartbeatQualityOkay: 'Acceptabil',
      heartbeatQualityPoor: 'Slab',
      heartbeatQualityCritical: 'Critic',
      ...
      heartbeatDatabaseDetail: 'Detalii bază de date',
      ...
      eventsToastGroupTitle: 'Popupuri toast',
      eventsToastGroupSubtitle:
        'Previzualizează variantele de popup ale aplicației fără o eroare reală.',
      ...
      eventToastSuccessLabel: 'Popup succes',
      eventToastSuccessHint: 'Afișează stilul de confirmare folosit pentru acțiuni finalizate.',
      eventToastSuccessTitle: 'Salvat',
      eventToastSuccessMessage: 'Sistemul de popupuri este pregătit pentru mesaje de succes.',
      eventToastInfoLabel: 'Popup informativ',
      eventToastInfoHint: 'Afișează stilul neutru folosit pentru mesaje contextuale.',
      eventToastInfoTitle: 'De știut',
      eventToastInfoMessage: 'Acesta este stilul popupului informativ.',
      eventToastWarningLabel: 'Popup avertisment',
      eventToastWarningHint: 'Afișează stilul de atenționare când ceva necesită atenție.',
      eventToastWarningTitle: 'Verifică asta',
      eventToastWarningMessage: 'Acest popup de avertisment evidențiază o problemă recuperabilă.',
      eventToastErrorLabel: 'Popup eroare',
      eventToastErrorHint: 'Afișează stilul asertiv folosit când o acțiune eșuează.',
      eventToastErrorTitle: 'Acțiunea a eșuat',
      eventToastErrorMessage: 'Acest popup de eroare este anunțat asertiv.',
      eventToastPlainLabel: 'Popup simplu',
      eventToastPlainHint: 'Afișează un popup doar cu mesaj, fără titlu sau pictogramă.',
