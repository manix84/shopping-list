...
export const ro: Messages = {
  ...
  labels: {
    ...
    exists: 'există',
    group: 'Grup',
    ingredientMode: 'Mod ingrediente',
    ingredientModeCups: 'Căni și linguri',
    ingredientModeMetric: 'Metric',
    ingredientModeSwitchToCups: 'Comută la căni și linguri',
    ingredientModeSwitchToMetric: 'Comută la măsuri metrice',
    items: 'Articole',
    locale: 'Limbă',
