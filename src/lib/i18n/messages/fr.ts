...
export const fr: Messages = {
  ...
  labels: {
    ...
    exists: 'existe',
    group: 'Groupe',
    ingredientMode: 'Mode ingrédients',
    ingredientModeCups: 'Tasses et cuillères',
    ingredientModeMetric: 'Métrique',
    ingredientModeSwitchToCups: 'Passer aux tasses et cuillères',
    ingredientModeSwitchToMetric: 'Passer aux mesures métriques',
    items: 'Articles',
    locale: 'Langue',
    mode: 'mode',
    order: 'Ordre',
