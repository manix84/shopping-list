...
export const nl: Messages = {
  ...
  labels: {
    ...
    exists: 'bestaat',
    group: 'Groep',
    ingredientMode: 'Ingredientenmodus',
    ingredientModeCups: 'Kopjes en lepels',
    ingredientModeMetric: 'Metrisch',
    ingredientModeSwitchToCups: 'Overschakelen naar kopjes en lepels',
    ingredientModeSwitchToMetric: 'Overschakelen naar metrische maten',
    items: 'Artikelen',
    locale: 'Taal',
    measurementMode: 'Meetmodus',
    measurementModeCooking: 'Kookmaten',
    measurementModeImperial: 'Imperiale maten',
    measurementModeMetric: 'Metrische maten',
    mode: 'modus',
    order: 'Volgorde',
    progress: 'Voortgang',
    qty: 'Aantal',
