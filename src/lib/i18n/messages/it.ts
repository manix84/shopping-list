...
export const it: Messages = {
  ...
  labels: {
    ...
    exists: 'esiste',
    group: 'Gruppo',
    ingredientMode: 'Modalità ingredienti',
    ingredientModeCups: 'Tazze e cucchiai',
    ingredientModeMetric: 'Metrico',
    ingredientModeSwitchToCups: 'Passa a tazze e cucchiai',
    ingredientModeSwitchToMetric: 'Passa alle misure metriche',
    items: 'Articoli',
    locale: 'Lingua',
