...
export const de: Messages = {
  ...
  labels: {
    ...
    ingredientModeCups: 'Tassen und Löffel',
    ingredientModeMetric: 'Metrisch',
    ingredientModeSwitchToCups: 'Zu Tassen und Löffeln wechseln',
    ingredientModeSwitchToMetric: 'Zu metrischen Maßen wechseln',
    items: 'Artikel',
    locale: 'Sprache',
    mode: 'Modus',
    order: 'Reihenfolge',
