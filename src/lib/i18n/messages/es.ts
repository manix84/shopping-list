...
export const es: Messages = {
  ...
  labels: {
    ...
    exists: 'existe',
    group: 'Grupo',
    ingredientMode: 'Modo ingredientes',
    ingredientModeCups: 'Tazas y cucharas',
    ingredientModeMetric: 'Métrico',
    ingredientModeSwitchToCups: 'Cambiar a tazas y cucharas',
    ingredientModeSwitchToMetric: 'Cambiar a medidas métricas',
    items: 'Artículos',
    locale: 'Idioma',
