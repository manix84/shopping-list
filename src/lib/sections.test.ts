...
describe('section detection', () => {
  it.each([
    ...
    [UK_CONFIG, 'Dijon Mustard – 25 Ml', 'tinned_jarred'],
    [UK_CONFIG, 'Ketchup – 120 Ml', 'tinned_jarred'],
    [UK_CONFIG, 'Tomato Ketchup – 120 Ml', 'sauces'],
    [UK_CONFIG, 'Soya Sauce – 150 Ml', 'sauces'],
    [UK_CONFIG, 'Sriracha', 'cooking_ingredients'],
    [UK_CONFIG, 'Liquid Smoke – 1⁄2 Tsp', 'cooking_ingredients'],
    [UK_CONFIG, 'Marmite Optional – 1⁄2 Tsp', 'tinned_jarred'],
    [UK_CONFIG, 'Mayonnaise Full Fat – 650 Ml', 'tinned_jarred'],
